      ...
      {result.ok ? (
        ...
        <Card>
          <CardContent className="space-y-4 p-6 text-center">
            ...
            <Button render={<Link href={`/trainer/batches/${batchId}`} />} nativeButton={false} variant="outline">
              Back to batch
            </Button>
          </CardContent>
        </Card>
